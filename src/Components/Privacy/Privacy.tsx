    ...
    <Fragment>
      ...
      <section className={styles.textContainer}>
        ...
        <p>
          ...
          of the B.T.E. BOTLabs Trusted Entity GmbH. The use of the Internet
          pages of the B.T.E. BOTLabs Trusted Entity GmbH is possible without
        ...
        <p>
          ...
          the B.T.E. BOTLabs Trusted Entity GmbH. By means of this data
        ...
        <ol type="1">
          <li>
            ...
            <p>
              The data protection declaration of the B.T.E. BOTLabs Trusted
              Entity GmbH is based on the terms used by the European legislator
            ...
            <ol type="a">
              <li>
                <h3 className={styles.spacedHeading}>Personal data</h3>
                <p>
              ...
              <li>
                <h3 className={styles.spacedHeading}>Data subject</h3>
                <p>
              ...
              <li>
                <h3 className={styles.spacedHeading}>Processing</h3>
                <p>
              ...
              <li>
                <h3 className={styles.spacedHeading}> Profiling</h3>
                <p>
              ...
              <li>
                <h3 className={styles.spacedHeading}>Pseudonymization</h3>
                <p>
              ...
              <li>
                <h3 className={styles.spacedHeading}>Processor</h3>
                <p>
              ...
              <li>
                <h3 className={styles.spacedHeading}> Recipient</h3>
                <p>
              ...
              <li>
                <h3 className={styles.spacedHeading}> Third party</h3>
                <p>
              ...
              <li>
                <h3 className={styles.spacedHeading}> Consent</h3>
                <p>
                  Consent of the data subject is any freely given, specific,
                  informed and unambiguous indication of the data subjects
          ...
          <li>
            <h3 className={styles.spacedHeading}>Rights of the data subject</h3>
            <ol type="a">
              <li>
                <h3 className={styles.spacedHeading}>Right of confirmation</h3>
                <p>
              ...
              <li>
                <h3 className={styles.spacedHeading}>Right to rectification</h3>
                <p>
                  Each data subject shall have the right granted by the European
              ...
              <li>
                ...
                <p>
                  ...
                  by the B.T.E. BOTLabs Trusted Entity GmbH, he or she may, at
                  any time, contact any employee of the controller. An employee
                  of B.T.E. BOTLabs Trusted Entity GmbH shall promptly ensure
                ...
                <p>
                  ...
                  employee of the B.T.E. BOTLabs Trusted Entity GmbH will
              ...
              <li>
                ...
                <ul className={styles.bulletList}>
                  ...
                  <li>
                    ...
                    data subject for the establishment, exercise or defense of
                    legal claims.
                  </li>
                  <li>
                ...
                <p>
                  ...
                  personal data stored by the B.T.E. BOTLabs Trusted Entity
              ...
              <li>
                ...
                <p>
                  ...
                  have the right to object at any time to processing of personal
                  ...
                  purposes, the B.T.E. BOTLabs Trusted Entity GmbH will no
                ...
                <p>
                  ...
                  contact any employee of the B.T.E. BOTLabs Trusted Entity
                  GmbH. In addition, the data subject is free in the context of
              ...
              <li>
                ...
                <p>
                  ...
                  explicit consent, the B.T.E. BOTLabs Trusted Entity GmbH shall
              ...
              <li>
                ...
                <p>
                  ...
                  of the B.T.E. BOTLabs Trusted Entity GmbH.
                </p>
              </li>
            </ol>
          </li>
